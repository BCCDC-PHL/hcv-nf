...
include { pre_fastqc }		from './modules/qc.nf'
include { post_fastqc }		from './modules/qc.nf'
...
workflow{
    ...
    ch_ictv_ref = Channel.fromPath(params.ictv_ref)
    ...
    ch_maprawreads = maprawreads(cutadapter.out.out_reads.combine(ch_ictv_ref))
